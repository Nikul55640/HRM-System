...
const DepartmentModal = ({
 open, department, departments, onSubmit, onClose, isSubmitting 
}) => {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                className={formik.touched.code && formik.errors.code ? 'border-destructive' : ''}
                placeholder="e.g., HR"
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                className={formik.touched.location && formik.errors.location ? 'border-destructive' : ''}
                placeholder="e.g., Building A, Floor 2"
              />
              {formik.touched.location && formik.errors.location && (
                <p className="text-sm text-destructive">{formik.errors.location}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => formik.setFieldValue('parentDepartment', value)}
              >
                <SelectTrigger>
