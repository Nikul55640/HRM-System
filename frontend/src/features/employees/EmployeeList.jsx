...
import { fetchEmployees, deleteEmployee } from '../../store/thunks/employeeThunks';
import { setPagination, clearError } from '../../store/slices/employeeSlice';
...
const EmployeeList = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.success(`Employee ${selectedEmployee.personalInfo?.firstName} ${selectedEmployee.personalInfo?.lastName} has been deleted successfully`);
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      {isScoped && (
        <ScopeIndicator 
          ...
          message={`You are viewing employees from your assigned department${assignedDepartments.length > 1 ? 's' : ''} only.`}
          className="mb-4"
        />
      )}
