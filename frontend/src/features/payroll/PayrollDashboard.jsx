    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <p className="text-red-700">You do not have permission to view payroll data.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Manage employee payroll and salary structures</p>
      </div>
            ...
            {recentPayslips?.length > 0 ? (
              <div className="space-y-3">
                {recentPayslips.map((payslip) => (
                  <div key={payslip._id} className="flex justify-between items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                    <div>
              ...
              <p className="text-gray-600 text-center py-8">No recent payslips</p>
            )}
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-gray-900">
                  ₹{statistics?.payrollSummary?.totalGrossPay?.toLocaleString() || 0}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-red-600">
                  ₹{statistics?.payrollSummary?.totalDeductions?.toLocaleString() || 0}
                </span>
              </div>
