/**
 * Fix Frontend Role Names Script
 * Updates all frontend route files to use the new normalized role names
 */
...
// Function to recursively find all .jsx files in routes directory
...
function updateRoleNames(filePath) {
  ...
  // Replace role names in roles arrays
...
// Main execution
async function fixFrontendRoles() {
  console.log('🚀 Starting Frontend Role Names Fix...\n');
  ...
  console.log(`\n✅ Frontend Role Names Fix completed!`);
  ...
  console.log(`   3. Test dashboard access`);
}

// Run the fix
fixFrontendRoles().catch(console.error);