...
router.get('/upcoming', authorize(['SuperAdmin', 'HR']), getUpcomingEvents);

// Get event by ID (SuperAdmin, HR)
router.get('/:id', authorize(['SuperAdmin', 'HR']), getEventById);

// Create new event (SuperAdmin, HR)
router.post('/', authorize(['SuperAdmin', 'HR']), createEvent);

// Update event (SuperAdmin, HR)
router.put('/:id', authorize(['SuperAdmin', 'HR']), updateEvent);
